...
import { SubagentManagerLive } from '@subagents/src/manager.ts';
 ...
 */
export async function runTool<A, E>(runtime: SubagentRuntime, effect: Effect.Effect<A, E>, options: { signal?: AbortSignal; interruptMessage?: string } = {}) {
