...
/** Pure presentation rules for subagent snapshots. */
export class SubagentSnapshotFormatter {
	/** Return the current streaming text, or the latest finalized response. */
	static latestText(snap: SubagentSnapshot) {
	...
	/** Format elapsed lifetime using the current time for active runs. */
	static elapsed(snap: SubagentSnapshot) {
...
/** Backward-compatible presentation helper. */
export function latestText(snap: SubagentSnapshot) {
	return SubagentSnapshotFormatter.latestText(snap);
}

/** Backward-compatible presentation helper. */
export function formatElapsed(snap: SubagentSnapshot) {
	return SubagentSnapshotFormatter.elapsed(snap);
}
