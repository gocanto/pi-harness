...
import type { BackendName, SendError, SpawnError, SpawnTask, SubagentEvent, SubagentMeta } from '@subagents/src/domain.ts';
...
export class BackendRegistry extends Context.Service<BackendRegistry, ReadonlyMap<BackendName, SubagentBackend>>()('subagents/BackendRegistry') {}
